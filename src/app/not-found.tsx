  ...
  return (
    <main className="min-h-screen bg-navy flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <div className="w-24 h-24 bg-cyan/20 rounded-full flex items-center justify-center mx-auto mb-8">
          <span className="text-5xl font-bold text-cyan">404</span>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          ...
          <div className="flex gap-4 justify-center">
            <a
              ...
              className="btn btn-call text-sm"
            >
